...
class UserRouter {
	...
	mountRoutes() {
		...
		this.expressRouter.get('/listOne/:guid', ...MiddlewareGuid, controller.listOne)
		this.expressRouter.put('/update/:guid', ...MiddlewareGuid, controller.update)
		this.expressRouter.delete('/delete/:guid', ...MiddlewareGuid, controller.delete)
	}
}
